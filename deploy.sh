...
# The next two functions require that you know your pxe network configuration & IP of resulting jumphost VM in advance. 
#This IP/MAC info also then needs to be added in PDF & IDF files (not supported yet via this script)
...
# Copy files needed by Infra engine & BMRA in the jumphost VM (under hw_config & sw_config) 
copy_files_jump
